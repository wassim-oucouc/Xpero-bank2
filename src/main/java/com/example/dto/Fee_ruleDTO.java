...
public class Fee_ruleDTO {
    ...
    public Fee_ruleDTO(String operation_type, int id, ModeFeeRule modeFeeRule, BigDecimal value, String currency, boolean is_active, Timestamp createdAt) {
